...
inventorNames = inventors.map(inventorName=>{
    return ({
       firstName: inventorName.first,
       lastName: inventorName.last
})});
...
// Enter your solution code here:
sortedByBirthYear = inventors.sort((big,small) => {
...
// Enter your solution code here:
firstLast = people.map((peoples)=>{
    let peopleName = peoples.split(' ');
...
// Enter your solution code here:
commentById = comments.find((cmnt)=>{
    return cmnt.id===823423;
})
